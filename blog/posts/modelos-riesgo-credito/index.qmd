...
|---------------------------------------------|--------------------|---------------------------------------------------------------------------------------------------|
| **Pago Mensual**                            | $500,000           | Monto que debe pagar el prestatario mensualmente si el préstamo es originado.                     |
| **Pagos Recibidos por Monto Total**         | $2,000,000         | Pagos realizados hasta la fecha para el monto total financiado.                                   |
| **Pagos Recibidos por Porción Inversionista**| $1,200,000         | Pagos realizados hasta la fecha para la porción financiada por inversionistas.                    |
| **Principal Recibido**                      | $1,800,000         | Monto principal recibido hasta la fecha.                                                           |
| **Último Pago Recibido**                    | $500,000           | Monto total del último pago realizado.                                                             |
| **Última Fecha de Pago (Día)**              | 20 de enero        | El último día de la semana en que se recibió el pago.                                              |
| **Última Fecha de Pago (Mes)**              | Enero 2025         | El mes en el cual se realizó el último pago.                                                      |
| **Último Informe de Crédito (Mes)**         | Octubre 2024       | El mes más reciente en el que se obtuvo el informe de crédito del prestatario.                     |
| **Años con el Préstamo**                    | 3 años             | Número de años que el prestatario lleva con el préstamo.                                           |
| **Recuperación**                            | $400,000           | La recuperación bruta después de la cancelación por incobrabilidad.                                |
| **Días Desde el Último Pago**               | 10 días            | Número de días desde que se recibió el último pago.                                               |
| **Última Fecha de Consulta**                | 15 de enero 2025   | El día más reciente en el que se consultó el crédito del prestatario.                              |
| **Saldo Pendiente (Monto Inversión)**       | $500,000           | Saldo principal pendiente de la parte financiada por inversionistas.                               |
| **Saldo Pendiente (Total)**                 | $1,000,000         | Saldo principal pendiente del monto total financiado.                                              |
| **Última Fecha de Pago (Año)**              | 2025               | El año en el cual se realizó el último pago.                                                      |
| **Tarifa por Cancelación**                  | $50,000            | Tarifa de cobro después de la cancelación por incobrabilidad.                                      |
| **Año del Préstamo**                        | 2022               | El año en que se originó el préstamo.                                                              |
| **Último Informe de Crédito (Año)**         | 2024               | El año más reciente en que se obtuvo el informe de crédito para este préstamo.                    |
| **Último Informe de Crédito (Días)**        | 100 días           | Número de días desde el último informe de crédito.                                                |

Dados estos datos, es posible observar que la respuesta por parte del modelo desplegado será que el prestatario muestra un **riesgo crediticio elevado** debido a múltiples indicadores, como lo pueden ser: capacidad de pago limitada, historial crediticio inconsistente y alta utilización de crédito rotativo. De acuerdo con esto, las condiciones del préstamo requieren garantías sustanciales, por lo que la cooperativa financiera podría considerar estrategias como la restructuración concertada de dichas condiciones o la venta de cartera en otra entidad.
...
Como ha sido posible observar, el presente informe contiene una serie de diferencias con respecto a la primera versión que se publicó con anterioridad, esto debido al conjunto de correcciones que fueron propuestas después de la evaluación del trabajo realizado. A continuación se da a conocer una visión general de los cambios que fueron desarrollados de manera específica, de manera que puedan ser comparados más fácilmente respecto a su primera implementación y pueda verse más claramente la mejora alcanzada en cada caso.

## Modelado y evaluación de desempeño

Con el objetivo de abordar las correcciones identificadas en relación con el desempeño del modelo de redes neuronales artificiales en la clasificación de categorías, especialmente la confusión entre las clases **Late** y **Current**, así como la baja representación de **In Progress**, se implementaron las siguientes mejoras en el procesamiento de datos, el balanceo de clases y la calibración del modelo:
