...
- **Input(shape=(X_train_bal.shape[1],))**: 
  - Define el tamaño de la entrada, igual al número de características en el dataset balanceado $X_{\text{train\_bal}}$.
...
- **Dense(128, activation='relu', kernel_regularizer=l2(1e-4))**:
  ...
  - Se usa un regularizador $L_2$ con un valor de $1 \times 10^{-4}$ para prevenir el sobreajuste al penalizar pesos grandes.
- **BatchNormalization()**:
