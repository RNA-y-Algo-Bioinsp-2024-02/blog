...
*El comercio masivo presenta nuevos desafíos, a medida que la llegada de la inteligencia artifical presenta soluciones a la medida de sus problemas.*
![El comercio masivo presenta nuevos desafíos, a medida que la llegada de la inteligencia artifical presenta soluciones a la medida de sus problemas.](walmart.jpg)
...
*Ilustración de una serie de tiempo.*
![Ilustración de una serie de tiempo](Dall.E_Serie.webp)
...
![Histograma de la variable respuesta.](descriptivo.png)
Elaboración propia.
...
*Matriz de correlación entre las características presentes en el dataset.*
![Matriz de correlación entre las características presentes en el dataset.](correlacion.png)
Elaboración propia.
...
*Ilustración del funcionamiento de una LSTM.*
![Ilustración del funcionamiento de una LSTM.](LSTM.webp)
Elaboración mediante GPT.
...
*Predicciones para las ventas en cada departamento.*
![Predicciones para las ventas en cada departamento.](ventas_departamento.png)
Elaboración propia.

**Figura 7.**

*Predicciones para las ventas.*
![Predicciones para las ventas.](prediccion_ventas.png)
Elaboración propia.
...
*Ilustración acerca del funcionamiento de una red neuronal convolucional.*
![Ilustración acerca del funcionamiento de una red neuronal convolucional.](funcionamiento_cnn.png)
Tomado de *An Introduction to Statistical Learning.*
...
*Arquitectura de una red neuronal convolucional.*
![Arquitectura de una red neuronal convolucional.](cnn_arquitectura.webp)
Tomado de https://developersbreach.com/convolution-neural-network-deep-learning/
...
*Matriz de confusión para la red neuronal convolucional.*
![Matriz de confusión para la red neuronal convolucional.](confusion1.png)
Elaboración propia.
...
*Evolución de la precisión y la función de pérdida en el entrenamiento y la validación.*
![Evolución de la precisión y la función de pérdida en el entrenamiento y la validación.](rendimiento.png)
Elaboración propia.
...
*Matriz de confusión para el modelo preentrenado.*
![Matriz de confusión para el modelo preentrenado.](confusion2.png)
Elaboración propia.
...
*Evolución de la precisión y la pérdida en entrenamiento y validación.*
![Evolución de la precisión y la pérdida en entrenamiento y validación.](rendimeinto2.png)
Elaboración propia.
...
*Ilustración de un modelo de recomendación.*
![Ilustración de un modelo de recomendación.](robot_ropa.webp)
Elaborado mediante GPT.
...
*Ilustración del resultado obtenido mediante embeddings.*
![Ilustración del resultado obtenido mediante embeddings.](embeddings.jpg)
...
*Evolución de la pérdida y el MAE para el modelo de recomendación.*
![Evolución de la pérdida y el MAE para el modelo de recomendación.](mae.png)
Elaboración propia.
