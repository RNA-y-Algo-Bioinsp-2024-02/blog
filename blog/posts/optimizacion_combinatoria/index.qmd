...
*Soluciones obtenidas mediante el algoritmo de colonia de hormigas para la optimización de la ruta en las carreteras identificadas.*
![Las tres rutas encontradas mediante el algoritmo de colonia de hormigas](soluciones_colonia_hormigas.gif)
*Nota.* Esta animación muestra las variaciones en las rutas óptimas propuestas por el algoritmo de colonia de hormigas para los tres escenarios que fueron analizados durante el desarrollo del presente ejercicio. Elaboración propia.

*Soluciones obtenidas mediante el algoritmo genético para la optimización de la ruta en las carreteras identificadas.*
![Las tres rutas encontradas mediante el algoritmo genético](soluciones_genetico.gif)
*Nota.* Igualmente, en esta animación se muestran las diferentes rutas óptimas propuestas por el algoritmo genético para los tres escenarios que fueron analizados durante el desarrollo del presente ejercicio. Elaboración propia.