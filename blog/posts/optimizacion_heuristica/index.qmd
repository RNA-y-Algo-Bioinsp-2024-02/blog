...
![](images/Rosenbrock_population_animation.gif)

### Función de Rastrigin

$$f(\mathbf{x}) = 10d + \sum_{i=1}^{d} \left[ x_i^2 - 10 \cos(2\pi x_i) \right]$$

![](images/Rastrigin_population_animation.gif)

### Función de Schwefel

$$ f(\mathbf{x}) = 418.9829d - \sum_{i=1}^{d} x_i \sin(\sqrt{|x_i|}) $$

![](images/Schwefel_population_animation.gif)

### Función de Griewank

$$ f(\mathbf{x}) = 1 + \frac{1}{4000} \sum_{i=1}^{d} x_i^2 - \prod_{i=1}^{d} \cos\left(\frac{x_i}{\sqrt{i}}\right) $$

![](images/Griewank_population_animation.gif)
...
![](images/Goldstein_Price_population_animation.gif)

### Función de las seis jorobas de camello

$$ f(x_1, x_2) = \left(4 - 2.1x_1^2 + \frac{x_1^4}{3}\right)x_1^2 + x_1x_2 + \left(-4 + 4x_2^2\right)x_2^2 $$

![](images/Camel_Six_Humps_population_animation.gif)
:::
...
![](images/Rosenbrock_particulas_animation.gif)

### Función de Rastrigin

$$f(\mathbf{x}) = 10d + \sum_{i=1}^{d} \left[ x_i^2 - 10 \cos(2\pi x_i) \right]$$

![](images/Rastrigin_particulas_animation.gif)

### Función de Schwefel

$$ f(\mathbf{x}) = 418.9829d - \sum_{i=1}^{d} x_i \sin(\sqrt{|x_i|}) $$

![](images/Schwefel_particulas_animation.gif)

### Función de Griewank

$$ f(\mathbf{x}) = 1 + \frac{1}{4000} \sum_{i=1}^{d} x_i^2 - \prod_{i=1}^{d} \cos\left(\frac{x_i}{\sqrt{i}}\right) $$

![](images/Griewank_particulas_animation.gif)
...
![](images/Goldstein_Price_particulas_animation.gif)

### Función de las seis jorobas de camello

$$ f(x_1, x_2) = \left(4 - 2.1x_1^2 + \frac{x_1^4}{3}\right)x_1^2 + x_1x_2 + \left(-4 + 4x_2^2\right)x_2^2 $$

![](images/Camel_Six_Humps_particulas_animation.gif)
:::
...
![](images/Rosenbrock_diferential_evolution_animation.gif)

### Función de Rastrigin

$$f(\mathbf{x}) = 10d + \sum_{i=1}^{d} \left[ x_i^2 - 10 \cos(2\pi x_i) \right]$$

![](images/Rastrigin_diferential_evolution_animation.gif)

### Función de Schwefel

$$ f(\mathbf{x}) = 418.9829d - \sum_{i=1}^{d} x_i \sin(\sqrt{|x_i|}) $$

![](images/Schwefel_diferential_evolution_animation.gif)

### Función de Griewank

$$ f(\mathbf{x}) = 1 + \frac{1}{4000} \sum_{i=1}^{d} x_i^2 - \prod_{i=1}^{d} \cos\left(\frac{x_i}{\sqrt{i}}\right) $$

![](images/Griewank_diferential_evolution_animation.gif)
...
![](images/Goldstein_Price_diferential_evolution_animation.gif)

### Función de las seis jorobas de camello

$$ f(x_1, x_2) = \left(4 - 2.1x_1^2 + \frac{x_1^4}{3}\right)x_1^2 + x_1x_2 + \left(-4 + 4x_2^2\right)x_2^2 $$

![](images/Camel_Six_Humps_diferential_evolution_animation.gif)
:::
